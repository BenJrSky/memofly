...
<html lang="en">
<head>
    <title>Code coverage report for src/dialog.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> dialog.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    layout.$on('return', this.onReturn.bind(this))
    dialog.$on('return', this.onReturn.bind(this))
&nbsp;
    this._vm = layout
    this._vmDialog = dialog
    this.container = options.container ? (<span class="branch-0 cbranch-no" title="branch not covered" >findContainer(options.container))</span> : this.container
